...
const TrussInfo = (props: TrussInfoProps) => {
	...
	const joint = jointDetails ? props.truss.joints[jointDetails.id] : null

	const canSubmit = Boolean(jointDetails && (!joint?.position.equals(position) || !joint?.externalForce.equals(externalForce)))
